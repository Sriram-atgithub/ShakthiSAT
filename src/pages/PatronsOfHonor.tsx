...
// The featured patron image is stored as "3.png" in src/img/Patrons/
...
const buildGalleryItems = (): GalleryItem[] =>
  Object.entries(patronImages)
    ...
    .sort(([a], [b]) => {
      ...
      const numA = parseInt(filenameA.match(/^
      const filenameA = a.split('/').pop() ?? '';
      const filenameB = b.split('/').pop() ?? '';
      const numA = parseInt(filenameA.match(/^
      const filenameA = a.split('/').pop() ?? '';
  ...
  return (
    <main className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 space-y-16">
        ...
        {/* Featured Patron: Smt. Meenakshi Lekhi */}
        {featuredPatronSrc && (
          <motion.div
        ...
        {/* Gallery Carousel (remaining patrons) */}
